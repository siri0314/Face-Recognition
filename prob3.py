...
model = linear_model.SGDClassifier(alpha=0.2, average=False, class_weight=None, epsilon=0.2,
       eta0=0.0, fit_intercept=True, l1_ratio=0.15,
       learning_rate='optimal', loss='hinge', max_iter=2000, n_iter=1000,
       n_jobs=1, penalty='l2', power_t=0.5, random_state=None,
       shuffle=True, tol=None, verbose=0, warm_start=False)
y_pred=model.fit(m,n).predict(m1)
